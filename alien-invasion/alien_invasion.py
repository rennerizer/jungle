...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Define the game statistics and scoreboard
    ...
    def _check_bullet_alien_collisions(self):
        """ Respond to bullet-aliend collisions"""
        # Check for any bullets that have hit aliens, then remove them
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            # Remove any remaining aliend and bullets
            self.aliens.empty()
            self.bullets.empty()
